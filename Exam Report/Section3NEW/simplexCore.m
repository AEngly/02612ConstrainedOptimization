function [x,fval,exitflag,output,lambda,Abar,bbar,gbar] = simplexCore(g,Aeq,beq,A,cub,clb,lb,ub,options)
...
% ---------------- IMPLEMENTATION --------------
    ...
    lambda.eqlin = -eqLambda; % Lagrange is defined with opposite sign in linprog
