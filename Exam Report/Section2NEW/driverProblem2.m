...
options_ip = optimoptions('quadprog','Display','off', 'MaxIterations', 1000);
...
n_max = 50;
step = 2;
Variable_names = ["Random QP","Random QP with Box Constraints","Huber Fitting"];
...
for n = problem_sizes
    fprintf("Running active-set QP solver on Huber Fitting with n = %d\n.", n);
...
maxiter = 100;
[H,g,A,b,C,dl,du,l,u] = MinimalQP();
[xas, iter, x_k] = QP_InteriorPointPDPC(H, g, A, b, C, dl, du, l, u, maxiter,'x_k');
xstar = quadprog(H,g,[-C'; C'],[-dl;du],A',-b,l,u);
norm(xas-xstar)
...
saveas(gcf,'./Plots/272_Numerical_performance_IPPDQP.png')
